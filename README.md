...
Extension de navigateur (Chrome / Edge / Brave / Opera / Firefox) qui te prévient
sur ton PC pour **tout ce qui bouge dans tes trades** : un trade qui arrive, un
...
### Nouveau en v2.9.0 — le son ne se perd plus, et un son par événement
...
### Nouveau en v2.8.0 — plus rien sur la page Roblox
...
### Nouveau en v2.7.2 — la page ne rame plus
...
Aucune donnée ne sort de ton navigateur. Les seules requêtes réseau vont vers les
API publiques de **Roblox** (`trades`, `users`, `thumbnails`) et, si tu laisses
l'option activée, vers **Rolimon's** pour la table de valeurs des items. Pas de
serveur tiers, pas de télémétrie, pas de compte à créer.
