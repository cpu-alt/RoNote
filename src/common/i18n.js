...
const EN = {
  ...
  "Aurore": "Aurora",
  "Étoiles": "Stars",
  "Le graphique Rolimon's du Portefeuille, chiffres compris : change la période ou les courbes pour changer la carte. Aucun pseudo n'apparaît dessus.": "The Portfolio's Rolimon's chart, figures included: change the period or the curves to change the card. No username appears on it.",
  "Pas encore de courbe Rolimon’s.": "No Rolimon’s curve yet.",
  // Mode anonyme, Flex du portefeuille
  "montant masqué": "hidden amount",
  "rang {n}": "rank {n}",
  "Quitter le mode anonyme (H)": "Leave anonymous mode (H)",
  "Mode anonyme : masquer montants et pseudo (H)": "Anonymous mode: hide amounts and username (H)",
  "Mode anonyme": "Anonymous mode",
  "Partager une carte de ton portefeuille": "Share a card of your portfolio",
  "Flex mon portefeuille": "Flex my portfolio",
  "Carte anonyme": "Anonymous card",
  "Aucun montant : tes variations en % et ta courbe.": "No amounts: your % changes and your curve.",
  "Carte anonyme : aucun montant ni rang, seulement tes variations et ta courbe. Aucun pseudo.": "Anonymous card: no amounts or rank, only your changes and your curve. No username.",
  "variation": "change",
  "sur": "over",
  "montants masqués": "amounts hidden",
  "Courbe Rolimon's · montants, rang et pseudo masqués": "Rolimon's curve · amounts, rank and username hidden",
  "Courbe Rolimon's · pseudo masqué": "Rolimon's curve · username hidden",
  "GAIN": "GAIN",
  "PERTE": "LOSS",
  "VARIATION": "CHANGE",
  "SUR": "OVER",
