...
/**
 * Ses bundles, tires du rapport de portefeuille (portfolio.js) fait sur SON
 * compte. Seul ce qui s'affiche est garde : le rapport complet pese trop
 * lourd pour un cache par joueur.
 */
